...
def test_card_number_generator_invalid(start: int, end: int, expected_error: str) -> None:
...
def test_card_number_generator_valid(start: int, end: int, expected: list) -> None:
